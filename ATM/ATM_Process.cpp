			...
			switch (choice)
			{
				...
				case 2:
				{
					...
					else
					{
						...
						if (pin_num != pin_no)
						{
							cout << "Action failed...Pin Number not matched!!!" << endl;
							break;
						}
						...
						{
							cout << "Account balance is lower than the entered withdrawal amount!!!" << endl;
							break;
						}
						...
						else if (amount <= 5000)
						{
							if (amount >= 3000)
							{
								...
								if (denominations[1] >= (amount / 500))
								{
									...
									amount -= ((denom_500 - 1) * 500);
								}
								else if (amount >= (denominations[1] * 500))
								{
									denom_500 += denominations[1];
									amount -= ((denom_500 - 1) * 500);
								}
						...
						else if (amount > 5000)
						{
							...
							if (denominations[0] >= (amount / 2000))
							{
								...
								amount -= ((denom_2000 - 2) * 2000);
							}
							else if (amount >= (denominations[0] * 2000))
							{
								denom_2000 += denominations[0];
								amount -= ((denom_2000 - 2) * 2000);
							}
							if (denominations[1] >= (amount / 500))
							{
								denom_500 += amount / 500;
								amount -= ((denom_500 - 2) * 500);
							}
							else if (amount >= (denominations[1] * 500))
							{
								denom_500 += denominations[1];
